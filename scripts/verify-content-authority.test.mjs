...
test("project authority documents describe the world-first prompt architecture", async () => {
  ...
  requireAll(
    ...
    [
      ...
      "No generated corpus or approved narrative image exists",
      "Two paid generic endpoint-contract outputs",
      "No paid or synthetic image remains in the Railway bucket",
    ],
    "HANDOFF.md",
  );
});
