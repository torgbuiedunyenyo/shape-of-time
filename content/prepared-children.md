# Shape of Time - Prepared Child Movements

Each opening is its own book. Exact words in the root supply a premise; the child chooses its own
central person, place, local facts, and dramatic movement. Shared world physics still apply. The
quoted founding words are the passages the static reader may expose as prepared apertures.

## Child book: The Map on the Wall

> **Founded from root folio 12:** "The maps were always becoming wrong"
...
passengers to safety and puts a private route trace in public, losing her credential in the process.
The movement rests with a closed ferry console and a terminal wall that other crews have begun to
correct. The company still controls the ferries.

#### Folio 01 - The licensed route

On the afternoon run toward Phantas Minor, the licensed temporal route already disagrees with the
field instruments. Eniola compares the console with the crew’s paper soundings while the pilot holds
the ferry’s spatial circle on the lagoon. Passengers quietly reorganize pickups and work shifts
around the delay. A wide illustration makes the crossing ordinary public transit and shows repairs,
...
probationary credential, but every passenger must still get home; she disables the automatic return
and follows the local readings. A typeset map image adds a fact the prose withholds: the corporate
...
after correction. This folio stays text-led so the accumulated labor and her changing decisions are
...
wall. Prose stays with her suspension while other crews gather. The final illustration shows which
routes they add, where two veteran crews contradict Eniola, and which outer stops depend
...
Eniola its new sole authority. The movement will carry the first disputed correction through a
...
sees commuters arranging their day around different versions and realizes that her successful route
is already aging. The image contributes those material differences and the people relying on each.
"The copy with no witness" could later open the journey behind an
unaccountable mark.

#### Folio 06 - The correction

A driver from an outer Phantas stop brings a passenger-witnessed correction that contradicts
Eniola’s line because the current shifted overnight. Officials order unlicensed marks erased. Eniola
refuses to certify yesterday’s trace as permanent and leaves with the driver to compare readings.
This opens a new problem: how a public correction earns trust. The illustration makes the erased
and surviving marks legible through deterministic type and linework. "Yesterday’s safe route" could
later open the cost of following a map after its conditions changed.

## Child book: Blue Badges

> **Founded from root folio 04:** "fully managed Blitz night"
...
Mara begins with a familiar nightly job that feeds her family. Tomorrow’s programme puts that family
in the unsafe room, forcing her to decide whether to preserve the arrangement. By the end, residents
have publicly occupied the protected gallery and Mara has lost the job that depended on keeping them
out. Her block survives one raid and learns that the supposed safety rule was an access rule. The
tourist economy remains in place.

#### Folio 01 - Two rooms

Mara performs the nightly routine, seating blue-badged visitors in the reinforced gallery and local
families below. She is quick, good at calming children, and aware of which jokes earn tips. A cutaway
illustration should reveal the two standards of construction and comfort before Mara has language
...
below. She checks names and addresses because the paper determines where actual bodies will be
placed. A deterministic programme-and-roster image adds the badge lock time and the clause that
...
payout. Mara has made enforcement more expensive than leaving the residents in place. The escort
chooses the show. This folio remains text-led so the badge sequence and the waiting at the locked
doors retain their pressure. "The badge printer" could later open a worker’s quiet contribution to
the takeover.

#### Folio 04 - After the all-clear

After the all-clear, the operator fires Mara before she can inspect the rest of the shelter. Her block
keeps the unused badge stock and now knows exactly what it grants. The aftermath illustration gives
the reader information Mara reaches only at the end: the empty resident room has partially collapsed
beneath the intact, occupied gallery. Tonight they survive; the exploitative tourist economy remains.
"The house the itinerary spared" could later open the bargain that protected one address instead of
another.

## Child book: Performer Unknown

> **Founded from root folio 05:** "Performer unknown"
...
"The visitor who knew the last bar" could later open how he acquired the recording.
...
omits. They argue about cash, credit, and whether another buyer would offer either. This folio stays
text-led to keep every contributor present in the dispute. "Cida’s harmony" could later open the part
of the arrangement that no label can honestly attribute to one composer.
...
Eniola, Mara, and Ana give the child books their own centers. Lagos, Stepney, and Recife make the
prototype geographically and socially larger than Oakland. Each location contains work, family,
money, and ordinary local obligations. *The Map on the Wall* makes Phantas Minor material: its changing commuter current alters
the safe route, strands ordinary passengers when knowledge is withheld, and creates the movement’s
credential conflict. *Blue Badges* turns the Blitz tourism economy into a worker’s immediate choice
about shelter access. *Performer Unknown* follows cultural extraction through a band’s authorship
and money. The three books concern public transit, shelter access, and cultural authorship. Their
conflicts, not just their names, keep them from becoming copies.
